...
const CharacterEquipmentModalDetail = (props: {
    ...
    return (
        <Box sx={{
            ...
            {props.equipment.enchant && props.equipment.enchant.status !== null  && <Divider sx={dividerStyle} color={"gray"}/> }
            <Box>
                {props.equipment.enchant && props.equipment.enchant.status !== null  && props.equipment.enchant.status.map((enchant, index) => {
        ...
        >
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    {props.equipment.enchant && props.equipment.enchant.status !== null && props.equipment.enchant.status.map((status, index) => {
                        return (
