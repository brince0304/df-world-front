...
import {USER_CHARACTERS_SEARCH_URL} from "../../../../data/ApiUrl";
...
const CharacterLinkModal = (props: {
    ...
    return (
        <SearchCharacterModal isOpened={props.isOpened} handleClose={props.handleClose}
                              serachBox={<CustomSearchBox placeholder={"캐릭터 닉네임"}
