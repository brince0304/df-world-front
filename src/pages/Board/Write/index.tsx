 ...
 const WriteBoard = () => {
    ...
    return (
        <Container maxWidth={"md"} sx={{paddingTop: "20px", flexDirection: "column", gap: "20px"}}>
            ...
            <SearchCharacterModal isLoading={isCharacterSearchLoading}
                isOpened={characterSearchModalIsOpened} handleClose={handleCloseModal} serachBox={<CustomSearchBox placeholder={"캐릭터 검색"}
