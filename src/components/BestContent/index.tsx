...
const Index = (props: { data: ContentFlowProps[], handleNavigate:(id:number)=>void, flowTitle:ReactNode, chipColor :  "default" | "primary" | "secondary" | "error" | "info" | "success" | "warning" | undefined,
