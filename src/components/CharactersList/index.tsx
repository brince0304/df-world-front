...
const CharacterList = (props:{data:Content[], onClick: (e:React.MouseEvent)=>void,deletable?:boolean,adventure?:boolean, onClickDeleteButton?:(e:React.MouseEvent)=>void}) => {
    return (
