    ...
    return (
        <Box sx={containerStyle} ref={formRef}>
            <Paper
                ...
                <InputBase sx={{ml: 1, flex: 1, height: "100%"}} placeholder={props.placeholder} autoComplete={"off"}
                           onFocus={handleFocus} value={searchValue} onChange={handleOnchange} inputRef={inputRef}/>
