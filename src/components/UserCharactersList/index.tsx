...
const UserCharactersList = (props: {
  data: Content[];
  adventure: string,
}) => {
  ...
  return (
    ...
    {props.data.map((character, index: number) => {
            return(
              <CharacterCard key={index} character={character} deletable={true} adventure={props.adventure} onClickDeleteButton={deleteCharacter}  />
              )
            }
          )}
    </Grid>
